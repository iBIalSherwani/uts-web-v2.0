...
function navBar() {
  ...
  <div class="container-fluid">
    <a class="navbar-brand text-uppercase font-weight-bold"  href="/homepage" id="titlecolor"> 
    ...
    id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto ">
        <li class="nav-item m-auto">
          ...
          aria-current="page" href="/homepage" id="color">  
        ...
        <li class="nav-item m-auto">
          <a class="nav-link text-uppercase ml-2" href="/contactus" id="color"> 
